...
import (
	...
	"github.com/adwpc/xmobile/internal/importers/java"
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/adwpc/xmobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/adwpc/xmobile/bind/testdata/benchmark"}, "", "SeqBench")
}
