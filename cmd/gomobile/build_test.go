...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/adwpc/xmobile/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/adwpc/xmobile", "github.com/adwpc/xmobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/adwpc/xmobile", "github.com/adwpc/xmobile", 2},
		{"ffffffff t github.com/example/github.com/adwpc/xmobile", "", 0},
		{"ffffffff t github.com/example/repo", "", 0},
		{"ffffffff t github.com/example/repo/vendor", "", 0},
		{"ffffffff t _github.com/adwpc/xmobile/app", "github.com/adwpc/xmobile/app", 2},
	}
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/adwpc/xmobile/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
